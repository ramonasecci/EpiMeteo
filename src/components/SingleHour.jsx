const SingleHour = (props) => {
    ...
    return (
        <div key={key} className="text-white d-flex justify-content-between pe-4">
            <div className="d-flex justify-content-between">
                ...
                <div>
                    ...
                    {[1, 2, 3].includes(codtempo) &&
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="bi bi-clouds-fill text-white" viewBox="0 0 16 16">
                    ...
                    {[45, 48].includes(codtempo) &&
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="bi bi-cloud-haze2-fill text-white" viewBox="0 0 16 16">
                    ...
                    {[51, 53, 55].includes(codtempo) &&
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="bi bi-cloud-sun-fill text-white" viewBox="0 0 16 16">
                    ...
                    {[61, 63, 65, 66, 67, 80, 81, 82].includes(codtempo) &&
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="bi bi-cloud-drizzle-fill text-white" viewBox="0 0 16 16">
                    ...
                    {[71, 73, 75, 85, 86].includes(codtempo) &&
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="bi bi-cloud-snow-fill text-white" viewBox="0 0 16 16">
                    ...
                    {[95, 96, 99].includes(codtempo) &&
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="bi bi-cloud-lightning-fill text-white" viewBox="0 0 16 16">
            ...
            <div className="d-flex">
                <p className="me-3">{windspeed}&nbsp;km/h</p>
                <p>{gradi}&deg;C</p>
            </div>
